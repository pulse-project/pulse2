...
if ($_GET['group'] == 'enabled_firewall') {
    $groupname = sprintf (_T("Firewall status is enabled at %s", "xmppmaster"), date("Y-m-d H:i:s"));
}
elseif ($_GET['group'] == 'disabled_firewall') {
    $groupname = sprintf (_T("Firewall status is disabled at %s", "xmppmaster"), date("Y-m-d H:i:s"));
}
...
$groupmembers = xmlrpc_get_firewall_machines($groupType);
